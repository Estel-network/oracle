...
// source: oracle/oracle/price.proto
...
func (*Price) Descriptor() ([]byte, []int) {
	return fileDescriptor_6ef9b1f19d6a4a33, []int{0}
}
...
func init() {
	proto.RegisterType((*Price)(nil), "oracle.oracle.Price")
}

func init() { proto.RegisterFile("oracle/oracle/price.proto", fileDescriptor_6ef9b1f19d6a4a33) }

var fileDescriptor_6ef9b1f19d6a4a33 = []byte{
	// 137 bytes of a gzipped FileDescriptorProto
	,
}
...
func (m *Price) MarshalToSizedBuffer(dAtA []byte) (int, error) {
	...
	_ = l
	if m.Usd != 0 {
		i = encodeVarintPrice(dAtA, i, uint64(m.Usd))
		i--
		dAtA[i] = 0x10
	}
	if len(m.Denom) > 0 {
...
func (m *Price) Unmarshal(dAtA []byte) error {
	...
	for iNdEx < l {
		...
		case 2:
			if wireType != 0 {
				return fmt.Errorf("proto: wrong wireType = %d for field Usd", wireType)
			}
			m.Usd = 0
			for shift := uint(0); ; shift += 7 {
				if shift >= 64 {
